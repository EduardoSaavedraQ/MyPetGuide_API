...
class PetCreate(SQLModel):
    ...
    age: PositiveInt = Field(default=None, description="Edad de la mascota en años")
    ...
    sociability: PositiveInt | None = Field(default=None, ge=0, le=3, description="Nivel de sociabilidad de la mascota (1 a 3)")
    fur_length : PositiveInt | None = Field(default=None, ge=0, le=3, description="Longitud del pelaje de la mascota (1 a 3)")
    shedding_level: PositiveInt | None = Field(default=None, ge=0, le=3, description="Nivel de muda de pelaje de la mascota (1 a 3)")
    energy_level: PositiveInt | None = Field(default=None, ge=0, le=3, description="Nivel de energía de la mascota (1 a 3)")
    care_level_cost: PositiveInt | None = Field(default=None, ge=1, le=3, description="Nivel de costo de cuidado de la mascota (1 a 3)")
    care_dificulty: PositiveInt | None = Field(default=None, ge=1, le=3, description="Nivel de dificultad de cuidado de la mascota (1 a 3)")
    pet_size: PositiveInt | None = Field(default=None, ge=1, le=3, description="Tamaño de la mascota (1 a 3)")
